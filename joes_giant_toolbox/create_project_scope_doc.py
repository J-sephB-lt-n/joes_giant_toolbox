"""
This script creates a basic project scope document (markdown) using user input prompts.
It is intended to be run from the terminal, like this:
>>> python create_project_scope_doc.py
"""
...
for section_name in SECTION_DESC:
    if section_name == "Project Name":
        build_md_string += f"# Project Scope: {build_md_text_entries[section_name]}\n\n"
